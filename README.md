# genpark-acoustic-latent-neural-speech-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Acoustic latent neural speech synthesizer & audio tokenizer (WhisperSpeech style)
